...
const AboutInfo = () => {
    return (
        <div className='py-4'>
         <div className='static md:flex min-h-[80vh] justify-between items-center max-w-7xl mx-auto '>
            ...
            <div className='w-11/12 mx-auto md:w-5/12 space-y-4'>
                <h1 className="text-2xl md:text-4xl mb-2 md:mb-11 font-bold leading-tight">ABOUT US</h1>
                <p className='text-lg '>
